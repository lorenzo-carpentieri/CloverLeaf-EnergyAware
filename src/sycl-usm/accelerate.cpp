...
void accelerate(global_variables &globals) {
  ...
  for (int tile = 0; tile < globals.config.tiles_per_chunk; ++tile) {
    ...
    accelerate_kernel(globals.context.queue, t.info.t_xmin, t.info.t_xmax, t.info.t_ymin, t.info.t_ymax, globals.dt, t.field.xarea,
                      t.field.yarea, t.field.volume, t.field.density0, t.field.pressure, t.field.viscosity, t.field.xvel0, t.field.yvel0,
                      t.field.xvel1, t.field.yvel1);
  }
