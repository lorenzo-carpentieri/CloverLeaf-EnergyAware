...
void revert(global_variables &globals) {
  ...
  for (int tile = 0; tile < globals.config.tiles_per_chunk; ++tile) {
    ...
    revert_kernel(globals.context.queue, t.info.t_xmin, t.info.t_xmax, t.info.t_ymin, t.info.t_ymax, t.field.density0, t.field.density1,
                  t.field.energy0, t.field.energy1);
  }
}
